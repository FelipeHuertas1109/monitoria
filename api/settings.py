...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # o la ruta donde están tus plantillas
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    "default": {
        ...
        "NAME": "neondb",
        "USER": "neondb_owner",
        "PASSWORD": "npg_pWLrjDF6U3nJ",  # la misma que funcionó en psql
        "HOST": "ep-purple-brook-a4ff6ica-pooler.us-east-1.aws.neon.tech",
        "PORT": "5432",
        "OPTIONS": {
            "sslmode": "require"
        }
